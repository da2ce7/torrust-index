...
//!
//! These scenarios exercise the algebra of register, deregister, and re-register across Sentinels, outcome axes, and identity dimensions: dimension consistency, state recovery, and the Schur-complement conservation laws that govern marginalisation.
//!
//! Every scenario uses `torrust_assayer::testing::World` to reach the public lifecycle surface; no clock-dependent work lives in this file.
//!
//! # Cross-References
//!
