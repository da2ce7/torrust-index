...
mod tests {
    ...
    fn immaturity_raises_for_a_thin_deep_cell() {
        ...
        let mut deep = LedgerEntry::new_neutral(PersistentTimestamp::new(1_700_000_000, 0));
        let at = drive_eligible(&mut deep, 10, 0.0, LAMBDA_L);

        let mut root = LedgerEntry::new_neutral(PersistentTimestamp::new(1_700_000_000, 0));
