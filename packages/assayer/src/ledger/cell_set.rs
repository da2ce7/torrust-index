...
pub fn apply_cell_set_changes(
    ...
    for &key in current_report_cells {
        if let Some(entry) = ledger.get_mut(&key) {
            ...
            ledger.insert(key, LedgerEntry::new_neutral(now));
            appeared += 1;
        }
    }
...
mod tests {
    ...
    fn absence_increments_counter() {
        ...
        apply_cell_set_changes(&mut ledger, &empty_report, 3, PersistentTimestamp::new(1_700_000_000, 0));
    ...
    fn deletion_after_threshold() {
        ...
        let changes = apply_cell_set_changes(&mut ledger, &empty_report, 3, PersistentTimestamp::new(1_700_000_000, 0));
    ...
    fn root_never_deleted() {
        ...
        for _ in 0..10 {
            apply_cell_set_changes(&mut ledger, &empty_report, 0, PersistentTimestamp::new(1_700_000_000, 0));
        }
    ...
    fn presence_in_report_resets_counter() {
        ...
        apply_cell_set_changes(&mut ledger, &report_with_key, 3, PersistentTimestamp::new(1_700_000_000, 0));
