...
pub use scheduler::{LedgerGcTrigger, SWEEP_INTERVAL, spawn_ledger_gc_scheduler};
...
impl OutcomeLedger {
    ...
    pub fn create_sentinel(&self, id: SentinelId, now: PersistentTimestamp) {
...
mod tests {
    ...
    fn prune_axis_removes_rows_from_every_entry() {
        ...
        for sid in [SentinelId(1), SentinelId(2)] {
            ...
            let mut child = LedgerEntry::new_neutral(PersistentTimestamp::new(1_700_000_000, 0));
